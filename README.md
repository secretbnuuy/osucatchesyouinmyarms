...
- if sliderticks should be occuring more than once every 10ms, let them appear ≥1ms before the sliderend (instead of ≥10ms) ([link](https://github.com/secretbnuuy/osucatchesyouinmyarms/commit/7a1cd29b34d0fa637348663ebb4713f690aa0327))
...
score submission won't work from the dev build (which this is a copy of; so this lacks the closed-source code added to official releases)
